...
We are pleased to submit our manuscript, **"Path-AGNN-Cox: a reproducible statistical framework for testing patient-specific pathway rewiring in cancer survival analysis,"** for consideration as a research article in *Briefings in Bioinformatics*.
