...
para(doc, "All code is publicly available at [GitHub repository URL] and installable via PyPI "
          "([package name]). Processed datasets and full reproducible pipelines are provided; "
          "raw TCGA and GEO data are publicly available from their original sources.", space_after=12)
...
for text in [
    ...
    "associated GitHub repository [URL] and as a pip-installable Python package [name].",
