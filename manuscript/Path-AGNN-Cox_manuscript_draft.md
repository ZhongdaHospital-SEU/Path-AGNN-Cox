...
**Availability and implementation:** Source code, preprocessing pipelines (R + Python), and a PyPI-installable package with example notebooks are available at https://github.com/your-github/Path-AGNN-Cox.
...
- **Code:** https://github.com/your-github/Path-AGNN-Cox (MIT license; Python package `path_agnn_cox`, R preprocessing scripts in `data/scripts/`).
