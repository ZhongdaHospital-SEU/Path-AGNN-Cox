...
### Table 6. Framework validation of patient-specific pathway rewiring in LUAD and BRCA.
| Check | LUAD | BRCA |
|---|---|---|
| Pathways tested | 53 | 53 |
| Significant pathways, BH-FDR on the unadjusted test | 3 | 43 |
| Per-pathway permutation-calibrated pathways (FDR q<0.05) | 2 | 43 |
| Cohort-level label-permutation null, mean | 0.16 | 0.19 |
| Cohort-level label-permutation null, maximum | 34 | 19 |
| Cohort-level permutation P | P=0.014 | P<0.001 |
| Median percentile of real pathways, edge-matched null | 0.67 | 0.09 |
| Pathways above the 95th percentile, edge-matched null | 3 | 0 |
| Median percentile of real pathways, density-matched null | 0.69 | 0.20 |
| Pathways above the 95th percentile, density-matched null | 3 | 1 |
| Expected above the 95th percentile by chance | 2.65 | 2.65 |
| Known-pathway enrichment, top-20 by permutation P | 5 hits, P=0.689 | n.a. |
| Static-model total edge variance | 3.48e-13 | 2.81e-13 |
| Adaptive-model total edge variance | 1.92e+01 | 8.41e-02 |
| Randomized-partition control, significant pathways (3 seeds) | 26–48 | n.a. |
